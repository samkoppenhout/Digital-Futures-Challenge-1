...
console.log("In this demonstration there are 5 planes, named Plane 1 to Plane 5.")
console.log("-----------");
...
console.log("Setting plane capacity to 8.")
...
console.log("Removing plane 1 from airport.")
