...
console.log(chalk.blue("In this demonstration there are 5 planes, named Plane 1 to Plane 5. Any output in colour is for demonstration purposes and is not in the normal functionality of the software."));
console.log("-----------");
...
console.log("Displaying current contents of airport:");
airport.planeList.forEach(plane => { console.log(plane.Name) });
console.log(chalk.red("Plane 2 is not currently at the airport so it could not be removed."));
console.log("-----------");
